...
//	short USER_API dc_read_snr(HANDLE icdev, unsigned char *snr); //dc_readdevsnr
	...
	short USER_API dc_status(HANDLE icdev);
	...
	short USER_API dc_creat_mac2(HANDLE icdev, unsigned short DataLen, unsigned char *Data, unsigned char *MacData);
	short USER_API dc_creat_mac2_hex(HANDLE icdev, unsigned short DataLen, unsigned char *Data, unsigned char *MacData);
//	short USER_API dc_creat_mac_ecb(unsigned char *key, unsigned char *data, int len, unsigned char *mac);
...
// 	short USER_API dc_read_id_information(HANDLE icdev,unsigned char Type,unsigned int *length,unsigned char *outdata);
  ...
  short USER_API dc_getfingerdata(HANDLE icdev, int *len, unsigned char *data);
  ...
  short USER_API dc_keypad_SetButtonMark(HANDLE icdev, unsigned long mark_value, unsigned char use);
